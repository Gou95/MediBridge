...
public class OrderDetailsRepository {
    ...
    public MutableLiveData<List<OrderDetailsResponse>> orderDetailsData(Context context, String retailer_id,String order_no,String dealer_id,String order_status, OrderDetailListerner listener) {
        Call<List<OrderDetailsResponse>> call = apiInterface.getOrderDetails(retailer_id,order_no,dealer_id,order_status);
